...
class Tables:
    def __init__(self, *courses):
        ...
        self.possible_tables = [self._arrange_table_by_day(t) for t in all_tables if self.check_courses(t)]
    ...
    @staticmethod
    def _check_overlap(c_time1, c_time2):
        for day in "월화수목금":
            try:
    ...
    @staticmethod
    def _arrange_table_by_day(table):
